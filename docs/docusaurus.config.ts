...
const config: Config = {
  ...
  organizationName: 'xleap-ai', // Usually your GitHub org/user name.
  projectName: 'xleap', // Usually your repo name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/xleap-ai/xleap/tree/master/docs',
        },
        blog: {
